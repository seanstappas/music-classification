from data_extractor import get_training_songs_genres, get_one_song_per_genre, get_songs_genre
...
def plot_first_two_feature_vectors_one_song_per_genre(feature1=0, feature2=1):
...
def plot_first_two_feature_vectors_genre(feature1=0, feature2=1, genre='classical', num_songs=10):
...
def plot_all_combinations_of_two_feature_vectors_10_songs():
    for i in range(10):
        for j in range(i + 1, 10):
            plot_first_two_feature_vectors_one_song_per_genre(i, j)


def plot_all_combinations_of_two_feature_vectors_1_genre(genre):
    for i in range(10):
        for j in range(i + 1, 10):
            plot_first_two_feature_vectors_genre(i, j, genre)
